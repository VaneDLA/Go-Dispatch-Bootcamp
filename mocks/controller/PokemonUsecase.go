...
// PokemonUsecase is an autogenerated mock type for the PokemonUsecase type
type PokemonUsecase struct {
	mock.Mock
}

// CatchPokemon provides a mock function with given fields: p
func (_m *PokemonUsecase) CatchPokemon(p *model.PokemonAPI) (*model.Pokemon, error) {
	ret := _m.Called(p)
...
func (_m *PokemonUsecase) CreatePokemon(p *model.Pokemon) error {
	ret := _m.Called(p)
...
// FilterPokemons provides a mock function with given fields: typ, items, items_per_worker
func (_m *PokemonUsecase) FilterPokemons(typ string, items int, items_per_worker int) (model.Pokemons, error) {
	ret := _m.Called(typ, items, items_per_worker)

	var r0 model.Pokemons
	if rf, ok := ret.Get(0).(func(string, int, int) model.Pokemons); ok {
		r0 = rf(typ, items, items_per_worker)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(string, int, int) error); ok {
		r1 = rf(typ, items, items_per_worker)
	} else {
		r1 = ret.Error(1)
	}
...
func (_m *PokemonUsecase) GetAllPokemon() (model.Pokemons, error) {
	ret := _m.Called()
...
func (_m *PokemonUsecase) GetPokemonById(id int) (*model.Pokemon, error) {
	ret := _m.Called(id)
